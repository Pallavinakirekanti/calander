...
interface Props {
  ...
  handleChange: ({ key, value }: any) => void;
  translations: {};
}
      ...
      <div className="form-group row">
        ...
        <div className="col-sm-6">
          <Select
            ...
            style={{ width: 120 }}
            value={frequency}
            onChange={(e) => handleChange({ key: "frequency", value: e })}
            options={[
              {
                value: "Yearly",
                label: translateLabel(translations, "repeat.yearly.label"),
              },
              {
                value: "Monthly",
                label: translateLabel(translations, "repeat.monthly.label"),
              },
              {
                value: "Weekly",
                label: translateLabel(translations, "repeat.weekly.label"),
              },
              {
                value: "Daily",
                label: translateLabel(translations, "repeat.daily.label"),
              },
            ]}
          />
          {/* <select
